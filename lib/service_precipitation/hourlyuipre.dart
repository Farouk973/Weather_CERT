...
import 'package:smart_irrigation/service_precipitation/hourlypre.dart';
...
import 'menuprecipitation.dart';

class barhourui extends StatefulWidget {
  const barhourui({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  State<barhourui> createState() => _barhourui();
}

class _barhourui extends State<barhourui> {
  statsday Sm = new statsday();
                ...
                child: Column(
                    ...
                    children: [
                      Container(
                          ...
                          child: FutureBuilder(
                              future: Sm.gethourlyystats(),
                              builder: (context, snapshot) {
                                return CustomBarCharthour(
                                  statsdays: statsday.data,
                                );
                              }))
                    ]),
              ))
